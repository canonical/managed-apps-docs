...
ogp_site_url = "https://canonical-managed-apps-docs.readthedocs-hosted.com"
...
html_context = {
    ...
    "product_page": "ubuntu.com/managed/apps",
...
#  (multiproject disabled - unified single-project build)
